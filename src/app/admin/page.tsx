      ...
      <div className="max-w-[1420px] mx-auto px-3 sm:px-4 py-4">
        ...
        {tab==='hero' && (
          <div className="bg-white border border-neutral-200 p-4 space-y-4">
            <h2 className="font-black">HERO SECTION (Image or Video)</h2>
            <p className="text-xs text-neutral-500">Update the main homepage hero. Changes go live instantly on the storefront.</p>
