      ...
      <div className="max-w-[1420px] mx-auto px-3 sm:px-4 py-4">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="space-y-3 max-h-[70vh] overflow-auto pr-1">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div><label className="text-xs font-bold">TITLE (e.g. 10% OFF)</label><input value={heroDraft.title} onChange={e=> { setHeroDraft({...heroDraft, title: e.target.value}); setHasHeroChanges(true); }} className="w-full border border-neutral-300 px-3 py-2 text-sm" /></div>
                  <div><label className="text-xs font-bold">EYEBROW</label><input value={heroDraft.eyebrow || ''} onChange={e=> { setHeroDraft({...heroDraft, eyebrow: e.target.value}); setHasHeroChanges(true); }} className="w-full border border-neutral-300 px-3 py-2 text-sm" /></div>
                </div>
                <label className="text-xs font-bold">SUBTITLE</label><textarea value={heroDraft.subtitle || ''} onChange={e=> { setHeroDraft({...heroDraft, subtitle: e.target.value}); setHasHeroChanges(true); }} className="w-full border border-neutral-300 px-3 py-2 text-sm" rows={2} />
                {/* TYPOGRAPHY PALETTE */}
                <div className="border border-neutral-200 p-3 bg-[#fafafa] space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div><label className="text-xs font-bold">Title Color</label><div className="flex gap-1"><input type="color" value={heroDraft.titleColor || '#ffffff'} onChange={e=> { setHeroDraft({...heroDraft, titleColor: e.target.value}); setHasHeroChanges(true); }} className="w-10 h-9 border" /><input value={heroDraft.titleColor || '#ffffff'} onChange={e=> { setHeroDraft({...heroDraft, titleColor: e.target.value}); setHasHeroChanges(true); }} className="flex-1 border px-2 text-xs" /></div></div>
                    <div><label className="text-xs font-bold">Eyebrow Color</label><div className="flex gap-1"><input type="color" value={heroDraft.eyebrowColor || '#ffffff'} onChange={e=> { setHeroDraft({...heroDraft, eyebrowColor: e.target.value}); setHasHeroChanges(true); }} className="w-10 h-9 border" /><input value={heroDraft.eyebrowColor || '#ffffff'} onChange={e=> { setHeroDraft({...heroDraft, eyebrowColor: e.target.value}); setHasHeroChanges(true); }} className="flex-1 border px-2 text-xs" /></div></div>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div><label className="text-xs font-bold">Subtitle Color</label><div className="flex gap-1"><input type="color" value={heroDraft.subtitleColor || '#ffffff'} onChange={e=> { setHeroDraft({...heroDraft, subtitleColor: e.target.value}); setHasHeroChanges(true); }} className="w-10 h-9 border" /><input value={heroDraft.subtitleColor || '#ffffff'} onChange={e=> { setHeroDraft({...heroDraft, subtitleColor: e.target.value}); setHasHeroChanges(true); }} className="flex-1 border px-2 text-xs" /></div></div>
                    <div><label className="text-xs font-bold">Accent (first letter) Color</label><div className="flex gap-1"><input type="color" value={heroDraft.titleAccentColor || '#ff4d6d'} onChange={e=> { setHeroDraft({...heroDraft, titleAccentColor: e.target.value}); setHasHeroChanges(true); }} className="w-10 h-9 border" /><label className="flex items-center gap-1 text-xs"><input type="checkbox" checked={!!heroDraft.titleAccentEnabled} onChange={e=> { setHeroDraft({...heroDraft, titleAccentEnabled: e.target.checked}); setHasHeroChanges(true); }} /> Enable per-letter</label></div></div>
                  </div>
        ...
        {tab==='ticker' && (
          <div className="bg-white border border-neutral-200 p-4 space-y-3">
            ...
            <textarea value={tickerDraft.text} onChange={e=> { setTickerDraft({...tickerDraft, text: e.target.value}); setHasTickerChanges(true); }} rows={2} className="w-full border border-neutral-300 px-3 py-2 text-sm" />
            <div className="grid grid-cols-3 gap-2">
              <div><label className="text-xs font-bold">BG COLOR</label><div className="flex gap-1"><input type="color" value={tickerDraft.bgColor} onChange={e=> { setTickerDraft({...tickerDraft, bgColor: e.target.value}); setHasTickerChanges(true); }} className="w-10 h-9 border" /><input value={tickerDraft.bgColor} onChange={e=> { setTickerDraft({...tickerDraft, bgColor: e.target.value}); setHasTickerChanges(true); }} className="flex-1 border px-2 text-xs" /></div></div>
              <div><label className="text-xs font-bold">TEXT COLOR</label><div className="flex gap-1"><input type="color" value={tickerDraft.textColor} onChange={e=> { setTickerDraft({...tickerDraft, textColor: e.target.value}); setHasTickerChanges(true); }} className="w-10 h-9 border" /><input value={tickerDraft.textColor} onChange={e=> { setTickerDraft({...tickerDraft, textColor: e.target.value}); setHasTickerChanges(true); }} className="flex-1 border px-2 text-xs" /></div></div>
